...
export default function AppNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-[rgba(102,12,13,0.1)] shadow-[0_1px_8px_rgba(102,12,13,0.06)]">
      <div className="flex items-center justify-between px-5 py-3.5 max-w-5xl mx-auto w-full gap-3">
        ...
        <div className="flex items-center gap-0.5 overflow-x-auto scrollbar-none flex-1 justify-center min-w-0">
